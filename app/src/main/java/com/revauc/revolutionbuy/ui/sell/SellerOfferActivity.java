...
import com.revauc.revolutionbuy.databinding.ActivitySellerOfferBinding;
...
public class SellerOfferActivity extends BaseActivity implements View.OnClickListener {
    private ActivitySellerOfferBinding mBinder;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBinder = DataBindingUtil.setContentView(this, R.layout.activity_seller_offer);
