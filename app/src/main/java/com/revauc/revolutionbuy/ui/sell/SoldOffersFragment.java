...
public class SoldOffersFragment extends BaseFragment implements OnSellerOfferClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public SoldOffersFragment() {
        // Required empty public constructor
    }

    public static SoldOffersFragment newInstance() {
        return new SoldOffersFragment();
    }
    ...
    private void fetchCurrentOffers(final int page, int limit, boolean showLoading) {
        ...
        apiService.getSellerOffers(page,2,limit).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread()).subscribeWith(new DefaultApiObserver<SellerOffersResponse>(getActivity()) {
