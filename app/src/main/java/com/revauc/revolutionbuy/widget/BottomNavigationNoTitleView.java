...
public class BottomNavigationNoTitleView extends BottomNavigationView {
    // used for animation
    ...
    private BottomNavigationNoTitleViewOnPageChangeListener mPageChangeListener;
    private BottomNavigationMenuView mMenuView;
    private BottomNavigationItemView[] mButtons;
    // used for setupWithViewPager end

    public BottomNavigationNoTitleView(Context context) {
        super(context);
    }

    public BottomNavigationNoTitleView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BottomNavigationNoTitleView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        System.out.println("mMenuView:" + mMenuView + " mButtons:" + mButtons + " mOnClickListener" + mOnClickListener);
    ...
    public OnNavigationItemSelectedListener getOnNavigationItemSelectedListener() {
        ...
        return getField(getClass().getSuperclass(), this, "mListener");
    }
    ...
    /**
     * This method will link the given ViewPager and this BottomNavigationNoTitleView together so that
    ...
    public void setupWithViewPager(@Nullable final ViewPager viewPager, boolean smoothScroll) {
        ...
        if (mPageChangeListener == null) {
            mPageChangeListener = new BottomNavigationNoTitleViewOnPageChangeListener(this);
        }
     ...
     * necessary calls back to the provided {@link BottomNavigationNoTitleView} so that the tab position is
     * kept in sync.
     * <p>
     * <p>This class stores the provided BottomNavigationNoTitleView weakly, meaning that you can use
     * {@link ViewPager#addOnPageChangeListener(ViewPager.OnPageChangeListener)
     * addOnPageChangeListener(OnPageChangeListener)} without removing the listener and
     * not cause a leak.
     */
    private static class BottomNavigationNoTitleViewOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<BottomNavigationNoTitleView> mBnveRef;

        public BottomNavigationNoTitleViewOnPageChangeListener(BottomNavigationNoTitleView bnve) {
        ...
        public void onPageSelected(final int position) {
            final BottomNavigationNoTitleView bnve = mBnveRef.get();
            if (null != bnve)
...
//        }
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, BottomNavigationNoTitleView bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
