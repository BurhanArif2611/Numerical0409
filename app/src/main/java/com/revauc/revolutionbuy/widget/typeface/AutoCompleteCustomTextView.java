...
public class AutoCompleteCustomTextView extends android.support.v7.widget.AppCompatAutoCompleteTextView {
    /*
    ...
    public AutoCompleteCustomTextView(Context context, AttributeSet attrs, int defStyle) {
