...
/**
 * Regular {@link RadioButton} that just allows usage of 'customTypeface' attribute to specify
 * font for text rendering. See {@link TypefaceInitializer} for details.
 *
 * @author Konstantin Burov (aectann@gmail.com)
 */
public class TypefaceRadioButton extends android.support.v7.widget.AppCompatRadioButton implements TypefaceView {
