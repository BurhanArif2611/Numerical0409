...
public class UserProfileModel {
    ...
    String id,user_id,uid,displayName,provider,emaiiId,profile_pic,userPhone,userType,userVenderCode;
    ...
    public String getUserVenderCode() {
        return userVenderCode;
    }

    public void setUserVenderCode(String userVenderCode) {
        this.userVenderCode = userVenderCode;
    }
